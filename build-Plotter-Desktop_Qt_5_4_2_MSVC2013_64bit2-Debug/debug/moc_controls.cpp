...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Controls_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 23, 5) // "value"
    ...
    "Controls\0valueChanged\0\0value"
};
...
void Controls::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Controls::valueChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Controls::valueChanged(int _t1)
{
